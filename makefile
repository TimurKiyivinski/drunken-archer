...
OBJECTS = $(TARGET).o Identifiable.o GameObject.o Item.o Inventory.o IHaveInventory.o Player.o Bag.o Command.o LookCommand.o Location.o Path.o MoveCommand.o CommandProcessor.o
